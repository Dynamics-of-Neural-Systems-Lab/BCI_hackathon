#This file is fundamentally a copy of the file hvatnet in utils, modifying the main network to fit a mamba block
import torch
...
class MambaModel(nn.Module):
    """
    This mamba model is based on the HVAT network proposed as the baseline model, 
    exchanging the middle part by the MAMBA model without any twists
    ...
    def __init__(self, config: Config):
        ...
        self.mamba = MambaModule(model_dim = config.n_filters, nlayers = 1)
